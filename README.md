...
<p align="right">برای تماس و همکاری می‌توانید از طریق دیسکورد با من ارتباط برقرار کنید. آیدی من: <strong>great_devil</strong></p>
<p align="right">لینک مستقیم پروفایل دیسکورد من: [Click Here](https://discord.com/users/812641116918120469)</p>
<br>
